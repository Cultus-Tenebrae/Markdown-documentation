...
- **Спецификация основного стандарта** (**Markdown Common Mark**);
- **Спецификация расширения основного стандарта** (**GitHub Flavored Markdown**);
- **Специфичные конструкции GitHub**;
- **Приложения**:
    - Путь к файлу;
